...
def apply_rotary_emb(x, freqs_cis):
    ...
    # print("x shape: ", x_bsqh_2.shape)
    freqs_cis_1s1h_2 = reshape_for_broadcast(freqs_cis, x_bsnh_2)
    # print("freqs cis shape: ", freqs_cis.shape)
    # print("x * freqs cis shape: ", (x_bsnh_2 * freqs_cis_1s1h2).shape)
    # print("x * freqs cis: ", x_bsnh_2 * freqs_cis_1s1h2)
    # print("torch.view_as_real(x * freqs cis) shape: ", torch.view_as_real(x_bsnh_2 * freqs_cis_1s1h2).shape)
    # print("torch.view_as_real(x * freqs cis): ", torch.view_as_real(x_bsnh_2 * freqs_cis_1s1h2))
